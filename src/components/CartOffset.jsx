...
function CartOffset() {
  ...
  return (
    <div>
        <button onClick={()=>{setopen(true)}} className='bg-lime-100 relative cursor-pointer h-10 w-10 flex justify-center items-center rounded-full hover:bg-lime-300 translate-all duration-300 ease-linear'>
        ...
        <div className="w-full p-3">
            <ul>
                {cartItems.length > 0 ? cartItems.map(item=> (
                        <li key={item.id} className='flex group group my-3 bg-gray-50 cursor-pointer px-2 py-3 justify-center items-center gap-4'>
